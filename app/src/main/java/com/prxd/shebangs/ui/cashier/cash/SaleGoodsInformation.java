...
public class SaleGoodsInformation {
    public ArrayList<GoodsInformation> settlementList;             //结算数据
    ...
    public SaleGoodsInformation() {

    }

    public SaleGoodsInformation(ArrayList<GoodsInformation> settlementList, Vip vip, String payType, int useIntegral,
