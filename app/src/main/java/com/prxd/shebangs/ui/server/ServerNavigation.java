...
public class ServerNavigation extends Fragment implements ModuleNavigationAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_nav_server, container, false);
    ...
    public void onStart() {
        super.onStart();
        viewModel = ViewModelProviders.of(requireActivity()).get(ServerViewModel.class);
        //设置跨度，即时一行里面包含几个元素
