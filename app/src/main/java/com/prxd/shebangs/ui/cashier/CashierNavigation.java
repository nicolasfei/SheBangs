...
public class CashierNavigation extends Fragment implements ModuleNavigationAdapter.OnItemClickListener {

    private static final String TAG = "CashierNavigation";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_nav_cash, container, false);
    ...
    public void onStart() {
        super.onStart();
        viewModel = ViewModelProviders.of(requireActivity()).get(CashierViewModel.class);
        //设置跨度，即时一行里面包含几个元素
