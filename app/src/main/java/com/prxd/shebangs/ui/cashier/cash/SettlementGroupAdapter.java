...
public class SettlementGroupAdapter extends GroupedRecyclerViewAdapter {
    ...
    public void onBindFooterViewHolder(BaseViewHolder holder, int groupPosition) {
        ...
        holder.setText(R.id.textView14, mContext.getString(R.string.goods_price) + goodsMsg.price);
    }
    ...
    public void onBindChildViewHolder(BaseViewHolder holder, int groupPosition, int childPosition) {
        ...
        holder.setText(R.id.textView14, mContext.getString(R.string.goods_price) + child.price);
    }
}
