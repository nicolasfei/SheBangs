...
public class CashOldSaleDialog extends Dialog {
    ...
    public CashOldSaleDialog(@NonNull Context context) {
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (goodsType.equals("") || numV.equals("") || priceV.equals("")) {
                    Toast.makeText(getContext(), getContext().getString(R.string.inputError), Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public CashOldSaleDialog setTitle(String title) {
        this.title = title;
        return this ;
    }
